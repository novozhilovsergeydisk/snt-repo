...
Route::post('/billboard/add',['as' => 'billboard_add', 'middleware'=>'App\Http\Middleware\Roles', 'uses' => 'Admin\BillboardController@store']);
    ...
    Route::get('/electric-meter/get-form', ['as' => 'electric-meter-get-form', 'middleware'=>'App\Http\Middleware\Roles', 'uses' => 'Admin\ElectricMeterController@getForm']);

    Route::post('/electric-meter/upload-excel', ['as' => 'electric-meter-upload-excel', 'middleware'=>'App\Http\Middleware\Roles', 'uses' => 'Admin\ElectricMeterController@uploadExcel']);
});
